...
export const siteConfig = {
   ...
   *
   * Номер-заглушка намеренно состоит из нулей: такой номер не может
   * принадлежать реальному абоненту. Правдоподобный выдуманный номер
   * почти наверняка оказался бы чьим-то настоящим.
   */
  contacts: {
    phone: "+74950000000",
    ...
    telegram: "",
    whatsapp: "",
    /** Мессенджер MAX. Пока пусто — кнопка работает как заглушка. */
    max: "",
  },
